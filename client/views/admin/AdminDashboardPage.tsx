          ...
          <form onSubmit={handleSubmit} className="bg-white/5 border border-white/10 p-8 space-y-6">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="space-y-2">
                <label htmlFor="post-title" className="text-xs uppercase tracking-[0.3em] text-gray-500">Title</label>
                <input
                  id="post-title"
                  value={form.title}
              ...
              <div className="space-y-2">
                <label htmlFor="post-slug" className="text-xs uppercase tracking-[0.3em] text-gray-500">Slug</label>
                <input
                  id="post-slug"
                  value={form.slug}
            ...
            <div className="space-y-2">
              <label htmlFor="post-excerpt" className="text-xs uppercase tracking-[0.3em] text-gray-500">Excerpt</label>
              <textarea
                id="post-excerpt"
                value={form.excerpt}
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="space-y-2">
                <label htmlFor="post-date" className="text-xs uppercase tracking-[0.3em] text-gray-500">Date</label>
                <input
                  id="post-date"
                  type="date"
                  value={form.date}
              ...
              <div className="space-y-2">
                <label htmlFor="post-read-time" className="text-xs uppercase tracking-[0.3em] text-gray-500">Read Time</label>
                <input
                  id="post-read-time"
                  value={form.readTime}
              ...
              <div className="space-y-2">
                <label htmlFor="post-category" className="text-xs uppercase tracking-[0.3em] text-gray-500">Category</label>
                <input
                  id="post-category"
                  value={form.category}
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="space-y-2">
                <label htmlFor="post-author" className="text-xs uppercase tracking-[0.3em] text-gray-500">Author</label>
                <input
                  id="post-author"
                  value={form.author}
              ...
              <div className="space-y-2">
                <label htmlFor="post-published" className="text-xs uppercase tracking-[0.3em] text-gray-500">Published</label>
                <select
                  id="post-published"
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="space-y-2">
                <label htmlFor="post-featured-image" className="text-xs uppercase tracking-[0.3em] text-gray-500">Featured Image (Upload)</label>
                <input
              ...
              <div className="space-y-2">
                <label htmlFor="post-featured-image-alt" className="text-xs uppercase tracking-[0.3em] text-gray-500">Image Alt Text</label>
                <input
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="space-y-2">
                <label htmlFor="post-meta-title" className="text-xs uppercase tracking-[0.3em] text-gray-500">Meta Title</label>
                <input
                  id="post-meta-title"
              ...
              <div className="space-y-2">
                <label htmlFor="post-meta-description" className="text-xs uppercase tracking-[0.3em] text-gray-500">Meta Description</label>
                <input
            ...
            <div className="space-y-4">
              ...
              {sections.map((section, index) => (
                <div key={index} className="border border-white/10 p-4 space-y-3">
                  <label htmlFor={`post-section-heading-${index}`} className="sr-only">{`Section ${index + 1} heading`}</label>
                  <input
                    id={`post-section-heading-${index}`}
                  ...
                  />
                  <label htmlFor={`post-section-paragraphs-${index}`} className="sr-only">{`Section ${index + 1} paragraphs`}</label>
                  <textarea
                    id={`post-section-paragraphs-${index}`}
                  ...
                  />
                  <label htmlFor={`post-section-bullets-${index}`} className="sr-only">{`Section ${index + 1} bullets`}</label>
                  <textarea
                    id={`post-section-bullets-${index}`}
