      ...
      <div className="page-container max-w-2xl">
        ...
        <form onSubmit={handleSubmit} className="mt-10 space-y-6 bg-white/5 border border-white/10 p-8">
          <div className="space-y-2">
            <label htmlFor="admin-email" className="text-xs uppercase tracking-[0.3em] text-gray-500">Email</label>
            <input
              id="admin-email"
              type="email"
              required
          ...
          <div className="space-y-2">
            <label htmlFor="admin-password" className="text-xs uppercase tracking-[0.3em] text-gray-500">Password</label>
            <input
              id="admin-password"
              type="password"
              required
