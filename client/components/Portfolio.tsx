...
// Swiper styles are imported globally in app/layout.tsx
      ...
      <div className="page-container mb-12 flex flex-col gap-8 md:flex-row md:justify-between md:items-end">
        ...
        <div className="flex space-x-4">
           <button
             ...
             className="swiper-button-prev-custom w-12 h-12 border border-white/20 rounded-full flex items-center justify-center text-white hover:bg-primary hover:border-primary transition-all"
           >
             ←
           </button>
           <button
             ...
             className="swiper-button-next-custom w-12 h-12 border border-white/20 rounded-full flex items-center justify-center text-white hover:bg-primary hover:border-primary transition-all"
           >
             →
           </button>
        </div>
